...
class HelloControllerTest {
    ...
    private final WebTestClient client =
            WebTestClient.bindToController(new HelloController()).build();
    ...
    @Test
    void hello2() {
        client.get().uri("/hello2").exchange().expectBody(Hello.class).isEqualTo(new Hello("Hello, JSON!!"));
    }

    @Test
    void hello3() {
        final Flux<Hello> responseBody =
                client.get().uri("/hello3").exchange().returnResult(Hello.class).getResponseBody();
