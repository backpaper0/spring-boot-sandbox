...
public class RoundTripTimeRecorder implements ClientHttpRequestInterceptor {
    ...
    private class Recorder implements Runnable {
        ...
        public void run() {
            ...
            Object maybeTotalRoundTripTime =
                    httpServletRequest.getAttribute(ElapsedTimeConverter.REQUEST_ATTRIBUTE_NAME);
            ...
            httpServletRequest.setAttribute(
                    ElapsedTimeConverter.REQUEST_ATTRIBUTE_NAME, totalRoundTripTime + roundTripTime);
        }
    }
}
