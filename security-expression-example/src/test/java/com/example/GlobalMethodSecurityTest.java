...
public class GlobalMethodSecurityTest {
    ...
    void preFilter1() {
        ...
        // @see
        // org.springframework.security.access.expression.method.DefaultMethodSecurityExpressionHandler.filterCollection(Collection<T>, Expression, EvaluationContext, MethodSecurityExpressionOperations)
