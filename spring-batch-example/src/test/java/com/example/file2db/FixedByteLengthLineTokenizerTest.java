...
public class FixedByteLengthLineTokenizerTest {
    ...
    @BeforeEach
    void init() {
        List<Column> columns = List.of(new Column("foo", 6, DataType.STRING), new Column("bar", 3, DataType.NUMBER));
    ...
    void testNull() {
        ...
        FixedByteLengthLineTokenizer lineTokenizer =
                new FixedByteLengthLineTokenizer(columns, FixedByteLengthLineTokenizer.SHIFT_JIS);
