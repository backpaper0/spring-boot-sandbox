...
public class AdminController {
    ...
    public String detail(@RequestParam String username, Model model, @ModelAttribute("adminForm") AdminForm form) {
    ...
    public String updateValidity(
            @RequestParam String username,
            Model model,
            @ModelAttribute("adminForm") @Validated AdminForm form,
