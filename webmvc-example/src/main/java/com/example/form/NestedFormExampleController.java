...
public class NestedFormExampleController {
    ...
    public String index(NestedExampleForm form) {
        List<NestedExampleSubForm> subs =
                List.of(new NestedExampleSubForm(), new NestedExampleSubForm(), new NestedExampleSubForm());
        form.setSubs(subs);
    ...
    @PostMapping
    public String post(
            @Validated NestedExampleForm form, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
