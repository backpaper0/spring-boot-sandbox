...
public class DataBinderExampleTest {
    ...
    void testTypeConversionFailure() {
        ...
        assertArrayEquals(
                new String[] {
                    "typeMismatch.target.field3", "typeMismatch.field3", "typeMismatch.java.lang.Long", "typeMismatch"
                },
        ...
        assertArrayEquals(
                new String[] {
                    "typeMismatch.target.field8", "typeMismatch.field8", "typeMismatch.boolean", "typeMismatch"
                },
    ...
    void testBeanValidation() {
        ...
        assertArrayEquals(
                new String[] {"NotNull.target.field1", "NotNull.field1", "NotNull.java.lang.String", "NotNull"},
                bindingResult.getFieldError("field1").getCodes());

        assertFalse(bindingResult.hasFieldErrors("field2"));

        assertArrayEquals(
                new String[] {"Max.target.field3", "Max.field3", "Max.java.lang.Long", "Max"},
                bindingResult.getFieldError("field3").getCodes());
    }
