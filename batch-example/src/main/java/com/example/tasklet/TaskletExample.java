...
public class TaskletExample {
    ...
    public TaskletExample(
            JobRepository jobRepository, PlatformTransactionManager transactionManager, final HelloTasklet tasklet) {
    ...
    public Job taskletExampleJob() {
        return new JobBuilder("taskletExampleJob", jobRepository)
                .start(taskletExampleStep())
                .build();
    }
