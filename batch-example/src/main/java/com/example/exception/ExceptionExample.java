...
public class ExceptionExample {
    ...
    public Job exceptionExampleJob1() {
        return new JobBuilder("exceptionExampleJob1", jobRepository)
                .start(exceptionExampleStep1())
                .build();
    }
    ...
    public Job exceptionExampleJob2() {
        return new JobBuilder("exceptionExampleJob2", jobRepository)
                .start(exceptionExampleStep2())
                .build();
    }
    ...
    public Job exceptionExampleJob3() {
        return new JobBuilder("exceptionExampleJob3", jobRepository)
                .start(exceptionExampleStep3())
                .build();
    }
    ...
    public Job exceptionExampleJob4() {
        return new JobBuilder("exceptionExampleJob4", jobRepository)
                .start(exceptionExampleStep4())
                .build();
    }
