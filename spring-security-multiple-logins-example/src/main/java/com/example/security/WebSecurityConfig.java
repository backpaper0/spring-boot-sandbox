...
public class WebSecurityConfig {
    ...
    private static SecurityFilterChain securityFilterChainInternal(
            HttpSecurity http, UserDetailsService userDetailsService, String name) throws Exception {
        return http
                ...
                .securityContext(customizer -> {
                    ...
                    DelegatingSecurityContextRepository securityContextRepository =
                            new DelegatingSecurityContextRepository(delegate2, delegate1);
